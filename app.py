...
import pickle
data = pickle.load(open('E:\deployment\zomato\data.pickle', 'rb'))
similarities = pickle.load(open('E:\deployment\zomato\similarity.pickle', 'rb'))
hotel = pickle.load(open('E:\deployment\zomato\hotel.pickle', 'rb'))

tfidf = pickle.load(open('E:\\deployment\\zomato\\tfidf2.pkl','rb'))
model = pickle.load(open('E:/deployment/zomato/model_new.pickle','rb'))
